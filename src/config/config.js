...
const envVarsSchema = Joi.object()
  .keys({
    ...
    BOLNA_API_KEY: Joi.string().optional().description('Bolna AI API key (India account)'),
    BOLNA_API_BASE: Joi.string().optional().default('https://api.bolna.ai').description('Bolna AI API base URL (India)'),
    AGENT_ID_ENGLISH: Joi.string().optional().description('Bolna English agent ID (India account)'),
    AGENT_ID_HINDI: Joi.string().optional().description('Bolna Hindi agent ID (India account)'),
    BOLNA_US_API_KEY: Joi.string().optional().description('Bolna AI API key (US account - for US Plivo)'),
    BOLNA_US_API_BASE: Joi.string().optional().default('https://api.bolna.ai').description('Bolna AI API base URL (US account)'),
    AGENT_ID_US_ENGLISH: Joi.string().optional().description('Bolna English agent ID (US account)'),
    AGENT_ID_US_HINDI: Joi.string().optional().description('Bolna Hindi agent ID (US account)'),
    CALLER_ID: Joi.string().optional().description('Caller ID phone number'),
    PLIVO_AUTH_ID: Joi.string().optional().description('Plivo Auth ID (India Account)'),
    PLIVO_AUTH_TOKEN: Joi.string().optional().description('Plivo Auth Token (India Account)'),
    PLIVO_US_AUTH_ID: Joi.string().optional().description('Plivo Auth ID (US Account)'),
    PLIVO_US_AUTH_TOKEN: Joi.string().optional().description('Plivo Auth Token (US Account)'),
...
const config = {
  ...
  bolna: {
    ...
    us: {
      apiKey: process.env.BOLNA_US_API_KEY,
      apiBase: process.env.BOLNA_US_API_BASE || 'https://api.bolna.ai',
      agentIdEnglish: process.env.AGENT_ID_US_ENGLISH,
      agentIdHindi: process.env.AGENT_ID_US_HINDI,
    },
  },
  plivo: {
    ...
    us: {
      authId: process.env.PLIVO_US_AUTH_ID,
      authToken: process.env.PLIVO_US_AUTH_TOKEN,
    },
  },
  exotel: {
